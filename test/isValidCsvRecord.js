...
tape( 'Identifies invalid CSV records.', function ( test ){
  var records = [
    {LON: '1', LAT: '2', NodeID: '3', Street1: '', Street2: '', SOME_PROP: ''},
    {LON: '1', LAT: '2', NodeID: '3', Street1: '', Street2: '', SOME_PROP: ''},
    {LON: '1', NodeID: '3', Street1: '', Street2: '', SOME_PROP: ''},
    {LON: '1', NodeID: '3', Street2: '', SOME_PROP: ''},
  ];
  records.forEach( function ( rec ){
    test.ok( !isValidCsvRecord( rec ), 'Record identified as invalid' );
  });

  var validRecord = {LON: '1', LAT: '2', NodeID: '1234', Street1: '3', Street2: '4', SOME_PROP: 'abs'};
